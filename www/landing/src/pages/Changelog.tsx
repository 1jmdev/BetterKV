...
const releases = [
    {
        ...
        changes: [
            {
                type: "feature",
                text: "Pub/Sub support with SUBSCRIBE, PUBLISH, PSUBSCRIBE",
            },
            {
                type: "feature",
                text: "Transaction support with MULTI, EXEC, DISCARD",
            },
            {
                type: "improvement",
                text: "30% improvement in pipeline throughput",
            },
            {
                type: "improvement",
                text: "Reduced memory overhead per key by 15%",
            },
            {
                type: "fix",
                text: "Fixed edge case in EXPIRE with negative TTL values",
            },
            {
                type: "fix",
                text: "Fixed RESP3 parsing for bulk strings with CRLF content",
            },
        ],
    },
    {
        ...
        changes: [
            {
                type: "feature",
                text: "Sorted Set data type with full command support",
            },
            ...
            {
                type: "improvement",
                text: "Optimized hash table resizing under load",
            },
            {
                type: "improvement",
                text: "Better error messages for invalid commands",
            },
            {
                type: "fix",
                text: "Fixed memory leak in long-running SCAN iterations",
            },
        ],
    },
    {
